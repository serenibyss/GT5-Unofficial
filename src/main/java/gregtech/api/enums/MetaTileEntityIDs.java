...
public enum MetaTileEntityIDs {
    ...
    Hatch_Input_Bus_SteamMK3(31044),
    Hatch_Input_Bus_SteamMK2(31045),
    Hatch_Input_Bus_Steam(31046),
    Hatch_Output_Bus_Steam(31047),
    Hatch_Output_Bus_SteamMK2(31048),
    Hatch_Output_Bus_SteamMK3(31049),
    ...
    Controller_SteamMegaMaceratorMulti(31373),
    ...
    WaterPump(31085),
    Controller_SteamMegaAlloySmelter(31991),
    Controller_SteamCompactFusionReactor(31992),
    Controller_SteamFusionReactor(31993),
    ...
    Controller_SteamMegaCompressor(31998),
    Controller_SteamWoodcutter(31999),
    Controller_SteamCarpenter(32000),
